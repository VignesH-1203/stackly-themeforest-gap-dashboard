...
<style>
    ...
    /* Sidebar heading and caption text */
    ...
    /* DO NOT force color on dropdown options — let Streamlit handle those */

    /* Main content headings */
    .main h1, .main h2, .main h3 { color: #FFFFFF !important; }

    /* Main content body text */
    .main p, .main span, .main label { color: #E5E7EB !important; }
