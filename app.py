...
<style>
    ...
    /* All headings — title, subheader, header */
    h1, h2, h3, h4, h5, h6 { color: #FFFFFF !important; }

    /* Body text, paragraphs, captions, markdown */
    p, span, label, div, .stMarkdown, .stCaption, [data-testid="stText"] { color: #E5E7EB !important; }

    /* KPI metric cards */
    [data-testid="stMetricLabel"] { color: #D1D5DB !important; }
    [data-testid="stMetricValue"] { color: #FFFFFF !important; }

    /* Selectbox / dropdown labels and text */
    .stSelectbox label, .stSelectbox div { color: #FAFAFA !important; }

    /* Dividers */
    hr { border-color: #374151 !important; }

    /* Caption text specifically */
    .stCaption, [data-testid="stCaptionContainer"] { color: #9CA3AF !important; }

    /* Make sure plotly charts don't get affected */
    .stPlotlyChart { color: inherit; }
</style>
